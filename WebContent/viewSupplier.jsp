  ...
  <body>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              ...
              <li>
                <a href="viewSComplaints.jsp"> Complaints by Schools </a>
              </li>
              <li>
    ...
    <main class="main-wrapper">
      ...
      <header>
        ...
        <p>Suppliers Information - Registered Suppliers</p>
    </header>
    ...
    <%   
	   ...
	   {       
		   ...
		   PreparedStatement psm = con.prepareStatement("select * from supplier_info");
		  ...
		  %>	      
	                 ...
	                 <td><a href="deleteSupplier.jsp?id=<%=rs.getString("id")%>" >Delete</a></td>
	                 </tr>
