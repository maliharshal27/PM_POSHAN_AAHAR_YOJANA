  ...
  <body>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              <li>
                <a href="alerts.html"> School Reports </a>
              </li>
              <li>
    ...
    <%   
	   ...
	   {       
		   ...
		   PreparedStatement psm = con.prepareStatement("select * from school_info");
		  ...
		  %>	      
	               ...
	               <td><%=rs.getString("pwd") %></td>
	                 ...
	                 <td><a href="deleteschool.jsp?id=<%=rs.getString("id")%>" >Delete</a></td>
	                 </tr>
