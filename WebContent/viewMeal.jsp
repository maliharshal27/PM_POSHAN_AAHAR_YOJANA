  ...
  <body>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              <li>
                <a href="viewGUpdate.jsp"> School Report </a>
              </li>
              <li>
                <a href="viewSComplaints.jsp"> Complaint by School </a>
              </li>
              <li>
    ...
    <main class="main-wrapper">
      ...
      <header>
        ...
        <p>Meal Information - Registered Meals</p>
    </header>
    ...
    <%   
	   ...
	   {       
		   ...
		   PreparedStatement psm = con.prepareStatement("select * from meal_info");
		  ...
		  %>	      
		              ...
		              <tr>
	                   <td><%=rs.getString("id") %></td>
	                    <td><%=rs.getString("mt") %></td>
	                 <td><%=rs.getString("quantity") %></td>
	                 <td><%=rs.getString("unit") %></td>
	                <td><a href="deleteMeal.jsp?id=<%=rs.getString("id")%>" >Delete</a></td>
	                 </tr>
