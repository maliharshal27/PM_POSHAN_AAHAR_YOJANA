...
<html lang="en">
  ...
  <form action="UpdateAttendence" method="post">
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="index.html">
          <img src="download.png" width="80" height="80" alt="logo" />
        </a>
      </div>
        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="addStudent.html" class="active">Add Students</a>  
              </li>
              <li>
              <a href="viewStudent.jsp" class="active">View Students</a>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Requirement Details</span>
            </a>
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="addRequirements.html">Add Requirements</a>
              </li>
              <li>
                <a href="viewRequirements.jsp">View Requirements </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Attendance Section</span>
            </a>
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              <li>
                <a href="viewAttendence.jsp"> Marks Attendance </a>
              </li>
              <li>
                <a href="viewAttendence.jsp"> View Attendance </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text"> View Section </span>
            </a>
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              <li>
                <a href="updatestudent.html"> Add Reports </a>
              </li>
               <li>
                <a href="viewReport.jsp"> View Reports </a>
              </li>
              <li>
                <a href="addComplaint.html"> Add Complaints  </a>
              </li>
               <li>
            ...
            >
              ...
              <span class="text">Logout Section</span>
            </a>
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              <li>
                <a href="school.html"> Logout </a>
              </li>
    ...
    <main class="main-wrapper">
              ...
              <div class="header-left d-flex align-items-center">
                ...
                <div class="menu-toggle-btn mr-20">
                    ...
                    <i class="lni lni-chevron-left me-2"></i> Menu 
                     ...
                     </button>   <img src="head.png" alt="Girl in a jacket" width="1150" height="200">
      ...
      <!-- ========== footer start =========== -->
        <header>
        <h1>Government Poshan Aahar Yojana</h1>
        <p>Add Student Information (School Login)</p>
    </header>
    ...
    <div class="container">
     ...
     <%   
	   ...
	   {    
		   ...
		   PreparedStatement psm = con.prepareStatement("select * from student_info1 where id=?");
		   psm.setString(1, id);
		  ...
		  %>	      
		             ...
		             <label for="rollno">SR No:</label>
             <input type="text" id="rollno" name="id"  value="<%=rs.getString("id") %>" readonly> 
             
		             <label for="rollno">Roll No:</label>
             <input type="text" id="rollno" name="rno"  value="<%=rs.getString("rno") %>" readonly>
		         
		           <label for="studentName">Student Name:</label>
            <input type="text" id="studentName" name="name" value="<%=rs.getString("name") %>" readonly>
               	
               	<label for="studentClass">Class:</label>
          <input type="text" id="studentName" name="class" value="<%=rs.getString("class") %>" readonly>
            	
            	   <label for="studentClass">Month :</label>
          <input type="text" id="studentName" name="month" value="<%=rs.getString("month") %>" >  
		          
		         <label for="studentClass">Day :</label>
          <input type="text" id="studentName" name="day" value="<%=rs.getString("day") %>" >   
  ...
  %>            
        ...
        <p class="note">Note: As a government official, please ensure that the information provided about the students for the Government Poshan Aahar Yojana is accurate. The current date of the laptop, along with height and weight, is required for record-keeping purposes.</p>
    </div>
    ...
    <script>
        ...
        addStudentForm.addEventListener('submit', function (event) {
            ...
            // Add logic to handle form submission here (e.g., sending data to the server).
            // You can use JavaScript, AJAX, or other methods to handle form submission.
        });
    </script>   
        <p>&copy; 2023 Government Poshan Aahar Yojana. Design by @27HarshalMali</p>
    </footer>
      <footer class="footer">
        <div class="container-fluid">
          <div class="row">
