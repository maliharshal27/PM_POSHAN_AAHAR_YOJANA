  ...
  <body>
    ...
    <%   
	   ...
	   {       
		   ...
		   PreparedStatement psm = con.prepareStatement("select * from requirement_info where semail=?");
		  ...
		  %>	      
	                 ...
	                 <td><%=rs.getString("delivarystatus") %></td>
	                 <td><%=rs.getString("status") %></td>
	                 <td><%=rs.getString("date") %></td>
	                 
	          <td><a href="deleteRS.jsp?id=<%=rs.getString("id")%>" >Delete</a></td>
	                 </tr>
