...
<html lang="en">
  ...
  <form action="viewStudent.jsp"></form>
  <body>
    <!-- ======== sidebar-nav start =========== -->
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="addRequirement.html">Add Requirements</a>
              </li>
              <li>
                <a href="viewRequirement.jsp">View Requirements </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              ...
              <li>
                <a href="viewUpdate.jsp"> View Reports </a>
    ...
    <main class="main-wrapper">
      ...
      <header>
        <h1><img src="st1.png" alt="Girl in a jacket" width="100" height="50"> Government Poshan Aahar Yojana</h1>
        <p>School Information - Registered Schools</p>
    </header>
    ...
    <%   
	   ...
	   {       
		   ...
		   PreparedStatement psm = con.prepareStatement("select * from student_info1 where semail=?");
		   psm.setString(1, GetterSetter.getSemail());
		  ...
		  %>	      
	        ...
	        <td><a href="updatestudent.jsp?id=<%=rs.getString("id")%>" >Update</a></td>
	          <td><a href="deletestudent.jsp?id=<%=rs.getString("id")%>" >Delete</a></td>
	                 </tr>
