  ...
  <body>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              <li>
                <a href="addReport.html"> Add Reports </a>
              </li>
              <li>
                <a href="viewReport.html"> View Reports </a>
    ...
    <%   
	   ...
	   {       
		   ...
		   PreparedStatement psm = con.prepareStatement("select * from complaint_info where semail=?");
		  ...
		  %>	      
	            ...
	            <td><a href="deleteComplaint.jsp?id=<%=rs.getString("id")%>" >Delete</a></td>
	                 </tr>
