...
<html lang="en">
  ...
  <form action="viewScool.jsp"></form>
  <body>
    <!-- ======== sidebar-nav start =========== -->
        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">SCHOOL DETAILE</span>
            </a>
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="addSchool.html" class="active">Add Schools</a>  
              </li>
              <li>
              <a href="viewSchool.jsp" class="active">View Schools</a>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">MEAL DETAILE</span>
            </a>
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              ...
              <li>
                <a href="viewMeal.jsp">View Meal </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">SUPPLIERS DETAILE</span>
            </a>
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              ...
              <li>
                <a href="viewSupplier.jsp"> View Supplies </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_4" class="collapse dropdown-nav">
              <li>
                <a href="viewGUpdate.jsp"> School Reports </a>
              </li>
              <li>
                <a href="viewSComplaints.jsp"> Complaints by School </a>
              </li>
              <li>
                <a href="viewApprove.jsp"> Approve Section </a>
              </li>
                        </ul>
          </li>
                 <li class="nav-item nav-item-has-children">
    ...
    <%   
	   ...
	   {       
		   ...
		   PreparedStatement psm = con.prepareStatement("select * from requirement_info");
		  ...
		  %>	      
	        ...
	        <td><a href="updateReuirement.jsp?id=<%=rs.getString("id")%>" ><%=rs.getString("status") %></a></td>
	          ...
	          <td><a href="deleteRequirement.jsp?id=<%=rs.getString("id")%>" >Delete</a></td>
	                 </tr>
